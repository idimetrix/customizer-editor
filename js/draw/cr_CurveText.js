(function (global) {
    ...
    if (fabric.cr_CurveText) {
        fabric.warn('fabric.cr_CurveText is already defined');
        return;
    }
    ...
    /**
     * Group class
     * @class fabric.cr_CurveText
     * @extends fabric.Text
     * @mixes fabric.Collection
     */
    fabric.cr_CurveText = fabric.util.createClass(fabric.Text, fabric.Collection, /** @lends fabric.cr_CurveText.prototype */ {
        /**
         * Type of an object
         * @type String
         * @default
...
//				}
         ...
         */
        toString: function () {
            return '#<fabric.cr_CurveText (' + this.complexity() + '): { "text": "' + this.text + '", "fontFamily": "' + this.fontFamily + '", "radius": "' + this.radius + '", "spacing": "' + this.spacing + '", "reverse": "' + this.reverse + '" }>';
        },
        /* _TO_SVG_START_ */
        /**
    ...
    /**
     * Returns {@link fabric.cr_CurveText} instance from an object representation
     * @static
     * @memberOf fabric.cr_CurveText
     * @param {Object} object Object to create a group from
     * @param {Object} [options] Options object
     * @return {fabric.cr_CurveText} An instance of fabric.cr_CurveText
     */
    fabric.cr_CurveText.fromObject = function (object) {
        return new fabric.cr_CurveText(object.text, clone(object));
    };

    fabric.util.createAccessors(fabric.cr_CurveText);
     ...
     * @default
     */
    fabric.cr_CurveText.async = false;
