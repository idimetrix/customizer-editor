angular.module('cr_Customify')
    .factory('cr_ITextAddCommand', ['cr_UtilsManager', 'cr_DrawFactory', function (cr_UtilsManager, cr_DrawFactory) {

        var cr_ITextAddCommand = function (text, x, y, styles) {
            var self = this;

            self.name = 'cr_ITextAddCommand';
