(function () {
    var cr_CurverCtrl = function ($rootScope, $scope, $timeout, $element, $safeApply, cr_Enums, cr_CommandsManager, cr_UtilsManager, cr_EventsManager, cr_DrawFactory) {
        ...
        function attachWatchers() {
            ...
            spacing_text_watcher = $scope.$watch('spacing', function (value) {
                //value = parseFloat(value);
                $scope.currentObject.spacing = value;
                $scope.currentTarget.set('spacing', value);
                $scope.currentTarget.setCoords();
            });
        }
        ...
        function detachWatchers() {
            ...
            spacing_text_watcher && spacing_text_watcher();
        }
        ...
        // Reverse
        $scope.Reverse_Curver = 'no'; // yes, no
    ...
    angular.module('cr_Customify').controller('cr_CurverCtrl', cr_CurverCtrl);
})();
