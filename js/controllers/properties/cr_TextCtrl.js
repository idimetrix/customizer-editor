(function () {
    var cr_Property_TextCtrl = function ($rootScope, $scope, $timeout, $element, $safeApply, cr_Enums, cr_CommandsManager, cr_UtilsManager, cr_EventsManager, cr_DrawFactory, cr_ImportExportManager) {
    ...
    angular.module('cr_Customify').controller('cr_Property_TextCtrl', cr_Property_TextCtrl);
})();
