(function () {
    var cr_LineCtrl = function ($rootScope, $scope, $timeout, $element, $safeApply, cr_Enums, cr_CommandsManager, cr_UtilsManager, cr_EventsManager, cr_DrawFactory) {
        ...
        function attachWatchers() {
            ...
            color_text_watcher = $scope.$watch('color_text', function (value) {
                console.log(123)
                $scope.currentObject.fill = value;
    ...
    angular.module('cr_Customify').controller('cr_LineCtrl', cr_LineCtrl);
})();
