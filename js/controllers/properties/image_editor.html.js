(function () {
    var cr_ImageEditorMotifsCtrl = function ($rootScope, $scope, $timeout, $element, $safeApply, cr_Enums, cr_CommandsManager, cr_UtilsManager, cr_EventsManager, cr_DrawFactory, FileUploader) {
    ...
    cr_ImageEditorMotifsCtrl.$inject = [
        '$rootScope',
        '$scope',
        '$timeout',
        '$element',
    ...
    angular.module('cr_Customify').controller('cr_ImageEditorMotifsCtrl', cr_ImageEditorMotifsCtrl);
})();
